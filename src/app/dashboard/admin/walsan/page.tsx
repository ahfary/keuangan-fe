      ...
      await toast.promise(
        ...
        deleteWalsanBulk(ids),
        {
          ...
          error: (err: any) => {
            ...
            const msg = err?.message || (err?.response?.message) || "Terjadi kesalahan saat menghapus.";
            return `Gagal: ${msg}`;
          },
        }
      );
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody>
              {isLoading ? (
                <tr>
                  <td colSpan={isSelectionMode ? 4 : 3} className="text-center p-8">
                ...
                <tr>
                  <td colSpan={isSelectionMode ? 4 : 3} className="text-center p-12">
